...
class _$SkillModelImpl implements _SkillModel {
  ...
  @override
  String toString() {
    return 'SkillModel(id: $id, name: $name, category: $category, proficiency: $proficiency, iconUrl: $iconUrl, yearsOfExperience: $yearsOfExperience, description: $description, projects: $projects)';
  }
