...
import 'package:kiet_portfolio/presentation/state_management/providers/portfolio_state_provider.dart';
...
class WorkExperienceSection extends HookConsumerWidget {
  ...
  Widget _buildMobileTimeline(List<ExperienceModel> experiences) {
  ...
  Widget _buildDesktopTimeline(List<ExperienceModel> experiences) {
    return Stack(
      children: [
        // Timeline Line
        Positioned(
